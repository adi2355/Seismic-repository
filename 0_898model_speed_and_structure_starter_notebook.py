...
# Quick analysis without running experiments
experiments = run_film_experiments_with_existing_weights(
      "/content/checkpoints/content/checkpoints/Extended_Absolute_Champion_epoch_40.pth"
   )
scope = analyze_experimental_scope("/content/checkpoints/content/checkpoints/Extended_Absolute_Champion_epoch_40.pth")

# Recommended: focused experiments around your champion
focused_framework = run_focused_lr_tuning(
    pretrained_weights_path=champion_weights_path,
    champion_frontend_lr=2e-5,
    champion_unet_lr=5e-6
)

# 3. If you want more, run balanced exploration (2.8 days)
balanced_framework = run_balanced_exploration(
    pretrained_weights_path=champion_weights_path,
