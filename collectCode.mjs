...
const DEFAULT_CONFIG = {
  ...
  excludePaths: [
    ...
    'app/globals.css',
    'app/layout.tsx',
    'src/services/UserObservationBinningService.ts',
    'src/services/StashPredictionService.ts',
    'src/services/RoutineHMMService.ts',
    'src/services/ForecastService.ts',
    'src/services/RoutineHMMService.ts',
    'src/services/ForecastService.ts',
    'src/services/ProphetForecastingService.ts',
    'src/services/ConsumptionLearningService.ts',
    ...
    'src/constants.ts',
    'yet_another_copy_of_speed_and_structure_starter_notebook.py',
    'validate_phase2_fixes.py',
    'dimension_compatibility_test.py',
    'final_test.py',
